...
struct Quiz {
    ...
    let questions = [
        ...
        Question(question: "Which of the following countries has the most residents?", possibleAnswers: ["Nigeria","Russia","Iran","Vietnam"], correctAnswer: 0),
        Question(question: "In what year was the United Nations founded?", possibleAnswers: ["1918","1919","1945","1954"], correctAnswer: 2),
        ...
        Question(question: "Which nation produces the most oil?", possibleAnswers: ["Iran","Iraq","Brazil","Canada"], correctAnswer: 3),
        ...
        Question(question: "Which of the following rivers is longest?", possibleAnswers: ["Yangtze","Mississippi","Congo","Mekong"], correctAnswer: 1),
